...
namespace Nano {
	namespace Rpc {
		...
		public:
			...
			void rpcReturnCall(std::string ip, short port, std::string id, std::string methodName, Json::Value params, const RpcResponseCallback callback, int milliseconds_timeout);
			void asyncRpcReturnCall(std::string ip, short port, std::string id, std::string methodName, Json::Value params, const RpcResponseCallback callback, int milliseconds_timeout);
